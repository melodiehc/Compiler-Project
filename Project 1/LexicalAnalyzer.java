...
class Token {
    ...
    Token(TokenType type, String value) { // Constructor for Token accepts type and value
        this.type = type;
        this.value = value;
    }
}
...
public class LexicalAnalyzer {
    ...
    public static void main(String[] args) {
        ...
        String filePath = "/Users/arianacontes/Downloads/cs361-main/cs361languages/src/Sum.java";
        try {
